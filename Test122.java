...
/*
	...
	만들 수 있는데 이러한 클래스를 중처 클래스라 한다.
	이는, 특정 클래스를 자신의 클래스 내부적인 용도로만 사용할 목적으로 쓰이는데
	특정 클래스를 마친자신의 멤버 변수나 메소드처럼 사용 할 수있게 한다.
	...
	1. static 중첩 클래스(중첩 내부 클래스)
		...
		모든 접근제어지시자를 사용 할 수있다.
		중첩 클래스가 포함하고있는 메소드에서는
		외부클ㄹ래스의 인스턴스 변수나 인스턴스 메소드에느 접근할 수 없고,
	...
	- static 중첩 클래스와 마찬가지호 프로그램 구조를 보다 더 간단하고
	알아보기 쉽도록 한 것이다.
	...
	4. 무명 클래스(익명 클래스 , annonymous class) 가끔 안드로이드 이벤트처리시 사용
	이름 없는 클래스
