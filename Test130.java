...
○ Wrapper 클래스
	...
	클래스로 설계하여 객체 단위로 처리한다.
	따라서 자바에서는 이러한 기본형 데이터를
	객체 단위로 처리할 수 있도록 클래스를 제 공할 수밖에 없는데
...
(객체) ob = a;
	...
	기본이 객체로 바껴서 담아지면 박싱   	    	기본이 박스안으로 가둬짐      
	객체가 기본 자료형으로 바뀌면 언박싱			객체가 기본형으로 열려짐
...
public class Test130
{
	public static void main(String[] args)
	{
		...
		b = c;				// Integer 형 데이터(객체) → int 형(기본형) 변수(오토 언박싱)
