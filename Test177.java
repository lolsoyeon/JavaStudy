/*=====================================================
  ■■■객체 직렬화(Object Serialization)  ■■■ 2022-08-01
 ======================================================*/
/*
○ 객체 직렬화(Object Serialization) 는
	...
	멤버 변수의 값을 보존한다거나(저장)
	다른 네트워크에 있는 호스트에 값을 보낼 경우 사용하게된다.
...
○ 객체 직렬화의 장점
	...
	객체 자체를 네트워트를 통해 손쉽게 교환할 수있게 된다.
	...
	또한 Bean 은 설계시 상태에 대한 정보를 저장할 때
...
○ Serializable 인터페이스
	...
	객체 직렬화를 하기 위해 먼저 직렬화가 가능하도록
	java.io.Serialxable 인터페이스를 구현해 주어야 한다.
...
{ 
	public static void main(String[] args) throws Exception
	{
		...
		//※ 『C:\JavaStudy』경로에 『data』디렉터리 생성후 다시 확인
		...
		//『test.ser』파일이 만들어질 디렉터리 경로가 구성되있지 않다면..
		...
		//Hashtable 자료구조 인스턴스 생성 map자료구조
		...
		if (f0.exists())
		{
			...
			//객체입력 스트림 (ois,OutputStream)로 부터 읽어들인 객체(Object)를
			//캐스팅(Hashtable)하여
