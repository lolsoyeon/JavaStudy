...
그리고, Calendar 클래스는 추상클래스이므로 직접 객체를 생성할 수없으며
실제적인  메소드 구현은  Calendar 클래스의 서브 클래스인
그레고리 클래스에 정의 되어있다.

시스템으로부터 현재 시스템 시간 정보를 얻어올 때
get() 라는 정적 메소드를 이용하여 객체를 생성할 수 있다.
생성된 Cla 클래스 객체는 시스템의 현재 날짜와 시간정보를 가지며,
이 객체가 생성되면 갖고있는 시간 정보들은 
get() 메소드를 이용하여 쉽게 자겨올 슈있다.

get()메소드는 내부적으로 gr 객체를 생성하여
돌려주기 때문에 g객체를 직접 생성하여 시간정보를 구할수도있다
